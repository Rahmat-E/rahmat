                    ...
                    <button class="btn btn-primary" name="btn_penulis_baru" id="btn_penulis_baru" data-bs-toggle="modal" data-bs-target="#modalFormPenulis">Penulis Baru</button>
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple" class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT id_author, author_name, email FROM author ORDER BY id_author DESC";
                                    ...
                                    while($row = mysqli_fetch_assoc($result)) {
                                        $nomor_urut++;
                                        $data_id_penulis=$row['id_author'];
                                        $data_nama_penulis=$row['author_name'];
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3 mt-3">
                                                ...
                                                <input type="password" class="form-control" id="password" placeholder="isi dengan password lama atau ganti dengan yang baru" name="password" required>
                                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <form method="POST">
                                            <div class="modal-body mb-3">
                                                Apakah Penulis dengan nama <?php echo  "<b>".$data_nama_penulis ."</b>";?> akan dihapus?
                                            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="password" class="form-control" id="email" placeholder="Masukkan Password Penulis..." name="password" required>
            </div>
            <div class="mb-3 mt-3 d-flex justify-content-end gap-2">
